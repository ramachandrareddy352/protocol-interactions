...
/* Long ETH
 for example each eth value is $100
 initial price is $100
 supply 10 eth i.e we supply upto $1000 of collateral
 borrow 300 dai

 with that 300 dai, swap the dai to eth in uniswap then we get 3 ETH
 3 ETH * $100 = $300

 after a week if the ETH value is increased to $200
 sell the 3 ETH and we get 3 ETH * $200 = $600 worth of DAI

 repay the 300 DAI to get back the 10 ETH
 and the profit is $300
*/
